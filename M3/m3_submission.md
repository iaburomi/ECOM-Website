...
<tr><td> <em>Generated: </em> 10/22/2023 11:02:05 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-101-F23/it202-javascript-and-css-challenge/grade/iaa47" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fiaa47%2F2023-10-16T00.04.15Screenshot%20(10).png.webp?alt=media&token=9c7ae338-97d9-472c-b68b-df002f92fd4d"/></td></tr>
<tr><td> <em>Caption:</em> <p>primary link<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fiaa47%2F2023-10-16T00.06.07Screenshot%20(11).png.webp?alt=media&token=cbc6dedf-6062-4762-9ffd-572ac93b2e60"/></td></tr>
<tr><td> <em>Caption:</em> <p>login link<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fiaa47%2F2023-10-16T00.06.13Screenshot%20(12).png.webp?alt=media&token=c558927a-7beb-4593-9611-dd0bbf61a987"/></td></tr>
<tr><td> <em>Caption:</em> <p>register link<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fiaa47%2F2023-10-16T00.06.18Screenshot%20(13).png.webp?alt=media&token=d8e2c4fa-2ec5-4466-ac87-36a387dd884c"/></td></tr>
<tr><td> <em>Caption:</em> <p>profile link<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fiaa47%2F2023-10-16T00.06.22Screenshot%20(14).png.webp?alt=media&token=8545550c-c17b-4906-972c-d8fecaf5411d"/></td></tr>
...
<tr><td> <em>Response:</em> <p>I used display:flex to make the display horizontal by calling the display and<br>setting it to flex which sets it horizontally.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>I called list-style-type which called the navigation list item markers and set it<br>to none.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I used background-color: and set it to the color I wanted.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I used nav li a:hover which allows me to change the color when<br>I hover above the links.&nbsp; I then used color: to set the color<br>to the color I wanted.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I used the ul brackets to set the bullet points to nothing by<br>using list-style-type: none and then changed the content to a checkmark.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I made the h1 tags upper case by calling h1 and using text-transform:<br>uppercase to change them all the uppercase.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I chose a light grey/green that I found on the color wheel and<br>changed the font to Times New Roman.&nbsp; I also styled the footer to<br>be red for it to stand out from the rest.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>The challenge list styling is only done on what&#39;s inside the body of<br>the text and not the whole page.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I used the h1 tag and called it to the top where I<br>was able to make it into a link.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I wasn&#39;t sure how to make the title tag a link but then<br>I did some research and found which code I had to add to<br>my challenge.html file.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned how to thoroughly use html and completed all the above challenges.&nbsp;<br>I learned how to color links and add checkmarks on pages as well.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Add a link to your pull request (hw branch to dev only)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/iaburomi/IT202-iaa47/pull/7">https://github.com/iaburomi/IT202-iaa47/pull/7</a> </td></tr>
<tr><td> <em>Sub-Task 3: </em> Add a link to your solution html file from prod (again you can assume the url at this point)</td></tr>
<tr><td>Not provided</td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-101-F23/it202-javascript-and-css-challenge/grade/iaa47" target="_blank">Grading</a></td></tr></table>